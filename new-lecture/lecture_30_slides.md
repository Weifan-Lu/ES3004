...
<!--
ESS 314 — Lecture 30 (Week 10): Synthesis
Companion to lectures/30_synthesis.md
This deck is built around a 20-minute active-learning review (slides 7-15).
Figures reference the existing, Python-generated, copyright-clean L30 assets:
  assets/figures/fig_synthesis_forward_operators.png
  assets/figures/fig_planetary_interiors.png
  assets/figures/fig_mantle_convection_engine.png
Relative path from slides/week10/ is ../../assets/figures/
Compile: marp --no-stdin --html lecture_30_slides.md -o lecture_30_slides.pdf
-->
...
![w:400 Ray-traced cross-section of Earth: direct P turns in the mantle to about 100 degrees, PKP refracts through the low-velocity outer core to re-emerge past 143 degrees with a shadow zone between, and S cannot cross the liquid outer core so it vanishes beyond about 103 degrees.](../../assets/figures/fig_l30_group1_earth.png)
