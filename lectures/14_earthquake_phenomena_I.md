...
The forward / inverse-problem framework introduced here will reappear in [Lecture 19 (Earth's gravity)](19_earths_gravity.md) and [Lecture 23 (Earth's magnetic field)](23_earth_magnetism.md), where the observable is no longer a travel time but a gravity or magnetic anomaly. The non-uniqueness identified in section 5 is a general feature of geophysical inverse problems, not a peculiarity of seismology.
